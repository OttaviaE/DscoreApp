...
```{r fig.cap="D-score results panel.", echo = FALSE, , out.width="98%", fig.align='default'}
...
```{r fig.cap="Results graphical representations.", echo = FALSE, , out.width="98%", fig.align='center'}
